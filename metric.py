...
__all__ = ['SegmentationMetric', 'batch_pix_accuracy', 'batch_intersection_union',
           'pixelAccuracy', 'intersectionAndUnion', 'hist_info', 'accuracy_score']
...
def hist_info(label_true, label_pred, n_class):
...
def accuracy_score(label_trues, label_preds, n_class=6):
    ...
    for lt, lp in zip(label_trues, label_preds):
        hist += hist_info(lt.flatten(), lp.flatten(), n_class)  # n_class, n_class
